...
public class LevelScenarioVisitor implements ScenarioVisitor {

    private StringBuilder stringBuilder;
    private int level;
    private int index=1;

    public LevelScenarioVisitor() {
    ...
    public String levelScenario(Scenario scenario, int level){
    ...
    public static String exampleUsage() {
        ...
        LevelScenarioVisitor sampleVisitor = new LevelScenarioVisitor();
        return sampleVisitor.levelScenario(scenario,3);
